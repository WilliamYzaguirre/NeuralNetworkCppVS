#ifndef NEURALNETWORKINTRINSIC_H
#define NEURALNETWORKINTRENSIC_H
...
class NeuralNetworkIntrinsic
{
public:
    NeuralNetworkIntrinsic(int layerCount, int neuronCount, int targetCount, int inputCount);

    ~NeuralNetworkIntrinsic();
